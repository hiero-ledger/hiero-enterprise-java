 ...
 */
@Schema(name = "Network: Fee", description = "Response DTO containing network transaction fee information.")
public record NetworkFeeResponse(
    @Schema(description = "The gas cost associated with the transaction.")
    long gas,
