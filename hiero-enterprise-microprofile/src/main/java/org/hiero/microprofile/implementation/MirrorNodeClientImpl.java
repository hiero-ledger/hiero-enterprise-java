...
public class MirrorNodeClientImpl extends AbstractMirrorNodeClient<JsonObject> {
  ...
  @Override
  public @NonNull Page<NftTransactionHistory> queryNftTransactionHistory(
    ...
    final Function<JsonObject, List<NftTransactionHistory>> dataExtractionFunction =
        node -> jsonConverter.toNftTransactionHistories(node);
    return new RestBasedPage<>(restClient.getTarget(), dataExtractionFunction, path);
  }
