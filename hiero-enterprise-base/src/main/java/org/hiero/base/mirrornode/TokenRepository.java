...
public interface TokenRepository {
   ...
   */
  @NonNull Page<Token> findByAccount(@NonNull AccountId accountId) throws HieroBaseException;
   ...
   */
  @NonNull
  default Page<Token> findByAccount(@NonNull String accountId) throws HieroBaseException {
   ...
   * @throws HieroBaseException if the search fails
   */
  @NonNull Optional<TokenInfo> findById(@NonNull TokenId tokenId) throws HieroBaseException;
   ...
   */
  @NonNull
  default Optional<TokenInfo> findById(@NonNull String tokenId) throws HieroBaseException {
   ...
   * @throws HieroBaseException if the search fails
   */
  @NonNull Page<Balance> getBalances(@NonNull TokenId tokenId) throws HieroBaseException;
   ...
   */
  @NonNull
  default Page<Balance> getBalances(@NonNull String tokenId) throws HieroBaseException {
    Objects.requireNonNull(tokenId, "tokenId must not be null");
