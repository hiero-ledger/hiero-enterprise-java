...
import org.hiero.base.implementation.data.BytesBasedDatatype;
 ...
 */
public record ContractParam<T>(
    @NonNull T value, @NonNull String nativeType, @NonNull ParamSupplier<T> supplier) {
  ...
  /**
   * Creates a new contract parameter with the given value and native type {@code address}. The
   * input must be address in solidty format.
   *
   * @param value the value of the parameter
   * @return the new contract parameter
   */
  ...
  /**
   * Creates a new contract parameter with the given value and converts the input to a Solidity
   * address format.
   *
  ...
  /**
   * Creates a new contract parameter using the given {@link AccountId} and converts it to a
   * Solidity address format.
   *
  ...
  /**
   * Creates a new contract parameter using the given {@link ContractId} and converts it to a
   * Solidity address format.
   *
