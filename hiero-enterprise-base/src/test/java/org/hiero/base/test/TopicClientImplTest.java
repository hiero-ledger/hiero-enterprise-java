...
public class TopicClientImplTest {
  ...
  @Test
  void shouldThrowExceptionOnSubscribeTopicWithInvalidLimit() {
    ...
    final IllegalArgumentException e3 =
        Assertions.assertThrows(
            IllegalArgumentException.class,
            () -> topicClient.subscribeTopic(topicId, subscription, 0));
    final IllegalArgumentException e4 =
        Assertions.assertThrows(
            IllegalArgumentException.class,
            () -> topicClient.subscribeTopic(topicId, subscription, startTime, endTime, 0));

    Assertions.assertEquals(msg, e3.getMessage());
    Assertions.assertEquals(msg, e4.getMessage());
  }
}
